                                    ...
                                    return (_jsxs("div", { className: "flex items-center gap-2", children: [i > 0 && (_jsx("div", { className: `w-12 h-px ${isComplete ? 'bg-emerald-500' : 'bg-[#2d2d44]'}` })), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: `w-7 h-7 rounded-full flex items-center justify-center text-xs font-semibold transition-colors ${isComplete
                                        ...
                                        return (_jsxs("button", { onClick: () => { setActiveTab(tab.id); setError(null); }, className: `flex-1 flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium transition-colors cursor-pointer ${isActive
                                                ...
                                                : 'text-zinc-400 hover:text-zinc-200 hover:bg-[#252538]/50'}`, children: [_jsx(Icon, { className: "h-4 w-4" }), _jsx("span", { className: "hidden sm:inline", children: tab.label })] }, tab.id));
                                                                            ...
                                                                            }, className: "absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded hover:bg-[#2d2d44] text-zinc-400 hover:text-zinc-200 transition-colors cursor-pointer", "aria-label": "Copy command", children: commandCopied ? (_jsx(Check, { className: "h-4 w-4 text-emerald-400" })) : (_jsx(Copy, { className: "h-4 w-4" })) })] }), _jsxs("p", { className: "text-xs text-zinc-500 mt-2 ml-7", children: ["Or use ", _jsx("code", { className: "text-zinc-400", children: "bunx" }), " / ", _jsx("code", { className: "text-zinc-400", children: "pnpm dlx" }), " instead of npx."] })] }), _jsxs("div", { children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [_jsx("span", { className: "w-5 h-5 rounded-full bg-amber-500/20 text-amber-400 text-xs font-bold flex items-center justify-center", children: "3" }), _jsx("span", { className: "text-sm text-zinc-200 font-medium", children: "Enable in your project" })] }), _jsxs("p", { className: "text-xs text-zinc-400 ml-7", children: ["Place the SKILL.md", result.resources.length > 0 ? ' and its resource files' : '', " in your project's ", _jsx("code", { className: "text-zinc-300", children: ".claude/skills/" }), " directory. Claude Code will automatically detect and use the skill when relevant."] })] })] })] })] }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "bg-[#1a1a2e] rounded-lg border border-[#2d2d44] overflow-hidden", children: [_jsx("div", { className: "px-4 py-3 border-b border-[#2d2d44]", children: _jsx("h3", { className: "font-semibold text-[#e4e4e7]", children: "Compliance Score" }) }), _jsxs("div", { className: "p-4 text-center", children: [_jsx("div", { className: `text-4xl font-bold mb-1 ${result.validation.score >= 80 ? 'text-emerald-400'
