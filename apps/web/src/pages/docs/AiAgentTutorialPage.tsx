      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6 mt-8">
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">What is an AI Agent?</h2>
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How do I get started with AI Agents?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How do I install Agent Skills?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How do I write effective prompts?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">Do I need coding skills to use AI Agents?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">What are the best practices for using AI Agents?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How do I enable skills on my VPS?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">Which AI platforms work with Agent Skills?</h2>
            <p className="text-muted-foreground" >
