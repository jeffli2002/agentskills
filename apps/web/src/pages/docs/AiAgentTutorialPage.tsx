      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6 mt-8">
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">What is an AI Agent?</h2>
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How do I get started with AI Agents?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How do I install Agent Skills?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How do I write effective prompts?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">Which AI platforms work with Agent Skills?</h2>
            <p className="text-muted-foreground">
