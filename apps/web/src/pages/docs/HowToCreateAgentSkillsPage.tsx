      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6 mt-8">
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How do I create an Agent Skill?</h2>
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">What is the SKILL.md format?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How does the Skill Composer work?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How do I write effective skill instructions?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How do I publish my skill to the marketplace?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">Can I keep my skills private?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How do I test my skill before publishing?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">What makes a successful Agent Skill?</h2>
            <p className="text-muted-foreground" >
