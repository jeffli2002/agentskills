    ...
    <div className="min-h-[80vh] py-12">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6 mt-8">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">What is the SKILL.md format?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How does the Skill Composer work?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How do I publish my skill to the marketplace?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">Can I keep my skills private?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How do I test my skill before publishing?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">What makes a successful Agent Skill?</h2>
            <p className="text-muted-foreground">
