      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6 mt-8">
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">What are AI agents?</h2>
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">Which platforms support Agent Skills?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">Are Agent Skills free?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How do I install a skill?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">Can I create custom skills?</h2>
            <p className="text-muted-foreground" >
