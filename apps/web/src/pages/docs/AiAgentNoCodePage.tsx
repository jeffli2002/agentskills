      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6 mt-8">
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" style={{ color: '#F4C542' }}>What are No-Code AI Agents?</h2>
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" style={{ color: '#F4C542' }}>How does the Skill Composer work without code?</h2>
            <p className="text-muted-foreground" style={{ color: '#858993' }}>
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" style={{ color: '#F4C542' }}>What are the benefits of No-Code development?</h2>
            <p className="text-muted-foreground" style={{ color: '#858993' }}>
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" style={{ color: '#F4C542' }}>What can I build with No-Code AI Agents?</h2>
            <p className="text-muted-foreground" style={{ color: '#858993' }}>
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" style={{ color: '#F4C542' }}>How do I get started without coding?</h2>
            <p className="text-muted-foreground" style={{ color: '#858993' }}>
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" style={{ color: '#F4C542' }}>When should I consider custom development?</h2>
            <p className="text-muted-foreground" style={{ color: '#858993' }}>
