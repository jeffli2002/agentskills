      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6 mt-8">
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">What are No-Code AI Agents?</h2>
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How does the Skill Composer work without code?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">What are the benefits of No-Code development?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">What can I build with No-Code AI Agents?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How do I get started without coding?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">When should I consider custom development?</h2>
            <p className="text-muted-foreground">
