  ...
  return (
    <div className="min-h-[80vh] py-12 bg-surface">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <h1 className="text-4xl font-bold mb-6 text-text-primary">What are Agent Skills? Complete Guide</h1>

        <div className="space-y-6 mt-8">
          <div className="p-6 rounded-xl bg-surface-elevated border border-divider">
            <h2 className="font-semibold text-lg mb-3 text-text-gold">What are Agent Skills?</h2>
          ...
          <div className="p-6 rounded-xl bg-surface-elevated border border-divider">
            <h2 className="font-semibold text-lg mb-3 text-text-gold">How do Agent Skills work?</h2>
            <p className="text-text-secondary">
          ...
          <div className="p-6 rounded-xl bg-surface-elevated border border-divider">
            <h2 className="font-semibold text-lg mb-3 text-text-gold">How to install Agent Skills?</h2>
            <p className="text-text-secondary">
          ...
          <div className="p-6 rounded-xl bg-surface-elevated border border-divider">
            <h2 className="font-semibold text-lg mb-3 text-text-gold">Are Agent Skills free to use?</h2>
            <p className="text-text-secondary">
          ...
          <div className="p-6 rounded-xl bg-surface-elevated border border-divider">
            <h2 className="font-semibold text-lg mb-3 text-text-gold">Which AI platforms support Agent Skills?</h2>
            <p className="text-text-secondary">
          ...
          <div className="p-6 rounded-xl bg-surface-elevated border border-divider">
            <h2 className="font-semibold text-lg mb-3 text-text-gold">How to create my own Agent Skill?</h2>
            <p className="text-text-secondary">
          ...
          <div className="p-6 rounded-xl bg-surface-elevated border border-divider">
            <h2 className="font-semibold text-lg mb-3 text-text-gold">What are popular use cases for Agent Skills?</h2>
            <p className="text-text-secondary">
          ...
          <div className="p-6 rounded-xl bg-surface-elevated border border-divider">
            <h2 className="font-semibold text-lg mb-3 text-text-gold">How do I enable skills on my VPS or local machine?</h2>
            <p className="text-text-secondary">
          ...
          <div className="p-6 rounded-xl bg-surface-elevated border border-divider">
            <h2 className="font-semibold text-lg mb-3 text-text-gold">How are skills reviewed and rated?</h2>
            <p className="text-text-secondary">
