      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6 mt-8">
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">What is OpenClaw?</h2>
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How does OpenClaw ensure security?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How do I install skills for OpenClaw?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How does the OpenClaw Converter work?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">What enterprise features does OpenClaw offer?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How do I convert skills to OpenClaw format?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How do teams use OpenClaw?</h2>
            <p className="text-muted-foreground">
