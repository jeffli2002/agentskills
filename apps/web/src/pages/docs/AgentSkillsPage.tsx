      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6 mt-8">
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">What is the Agent Skills Marketplace?</h2>
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How do I find skills by category?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How do ratings and reviews work?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">Can I contribute skills to the marketplace?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">How do I save skills for later?</h2>
            <p className="text-muted-foreground" >
          ...
          <div className="p-6 rounded-xl" style={{ backgroundColor: '#1F2328', border: '1px solid #353B44' }}>
            <h2 className="font-semibold text-lg mb-3" className="font-semibold text-lg mb-3 text-text-gold">What are popular skill categories?</h2>
            <p className="text-muted-foreground" >
