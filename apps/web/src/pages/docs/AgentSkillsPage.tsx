      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-6 mt-8">
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">What is the Agent Skills Marketplace?</h2>
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How do I find skills by category?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How do ratings and reviews work?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">Can I contribute skills to the marketplace?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">How do I save skills for later?</h2>
            <p className="text-muted-foreground">
          ...
          <div className="p-6 rounded-xl border bg-card">
            <h2 className="font-semibold text-lg mb-3 text-primary">What are popular skill categories?</h2>
            <p className="text-muted-foreground">
